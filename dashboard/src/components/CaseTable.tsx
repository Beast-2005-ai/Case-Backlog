        ...
        <table className="w-full">
          <thead>
            <tr className="bg-[#111111] text-gray-500 text-xs uppercase tracking-wider border-b border-[#2a2a2a]">
              <th className="px-6 py-5 text-center font-medium">Rank</th>
              <th className="px-6 py-5 text-center font-medium">Case ID</th>
              <th className="px-6 py-5 text-center font-medium">Type</th>
              <th className="px-6 py-5 text-center font-medium">Priority Score</th>
              <th className="px-6 py-5 text-center font-medium">Summary</th>
            </tr>
          </thead>
          <tbody>
